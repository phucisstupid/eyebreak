...
final class MenuBarContentViewTests: XCTestCase {
    ...
    func test_quitCommandInvokesClosure() {
        let model = AppModel.makeForTests(coordinator: SpyAppCoordinator(settings: AppSettings.default, snapshot: AppSnapshot(phase: .paused, breakCount: 0, nextBreakType: .short, breakSessionState: nil, schedulerState: .paused(progress: 120, origin: .running), idleDuration: 0, postpone: nil)))
