...
final class MenuBarContentViewTests: XCTestCase {
    ...
    func test_quitCommandInvokesClosure() {
        let coordinator = SpyAppCoordinator(settings: .default, snapshot: AppSnapshot(phase: .running, breakCount: 0, nextBreakType: .short, breakSessionState: nil, schedulerState: .running(progress: 0), idleDuration: 0, postpone: nil))
